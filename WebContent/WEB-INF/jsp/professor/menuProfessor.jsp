		...
		<div class="container-fluid">
			<div class="navbar-header">
				<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-9"></button>
		  		<a class="navbar-brand" href="/risk/professores">RISK</a>
			</div>
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-9">
				<ul class="nav navbar-nav">
			          ...
			          <ul class="dropdown-menu" role="menu">
			            <li><a href="/risk/professores">Meus Projetos</a></li>
			          ...
			          <ul class="dropdown-menu" role="menu">
			            <li><a href="/risk/professores/meusProjetos">Meus Planos de Riscos</a></li>
