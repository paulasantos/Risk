...
<script type="text/javascript" src="/risk/js/jquery.dataTables.min.js"></script>
...
<div class="content">
	...
	<div style="padding-top: 10px; margin-bottom: 50;">
		<table id="tableProjeto" class="table table-bordered" style="width: 98%; margin: 0 auto;">
			<thead>
				<tr>
...
$(document).ready(function() {
    $('#tableProjeto').dataTable({
        ...
        "oLanguage": { 
        	...
        	"sSearch" : "Pesquisar",
			"sInfoFiltered" : "Nenhum registro encontrado"
		}
    });
}); 
</script>
